...
Under the assumption that the null hypothesis is true, the probability that we would get the results we just obtained are 0.5735 or about 57.3% of the time. Since this value is very high (well above the 0.05 standard of significance), there is enough evidence to accept the null hypothesis. We conclude that for the general population, Genvoyabub does not have any effect on whether one contracts Aids. 
...
Under the assumption that the null hypothesis is true, the probability that we would get the results we just obtained are 0.5055 or about 50% of the time. Since this p-value is very high (well above the 0.05 standard of significance), there is enough evidence to accept the null hypothesis. We conclude that for the female population, Genvoyabub does not have any effect on whether one contracts Aids.  
...
Under the assumption that the null hypothesis is true, the probability that we would get the results we just obtained are 1 or nearly 100% of the time. A 100% probability means there is more than enough evidence to accept the null hypothesis. However, since it may seem unlikely that any event would occur 100% of the time, we will use the Fisher's exact test as a second approach.
...
Again, we get the p-value of 1 from the Fisher's exact test, with a confidence interval of 0.6347, 1.507. Therefore, we must accept the null hypothesis.
